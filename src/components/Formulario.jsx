                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (isSelected) {
                      ...
                      // El cable de acero no entra por poste, aunque el armado lo traiga
                      const ferreteriaFinal = {};
                      armado.items.forEach(item => { if (item.cant > 0 && !esCableAcero(item.idRef)) ferreteriaFinal[item.idRef] = item.cant; });
