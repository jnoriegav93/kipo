...
// El escáner QR vive en src/components/ScannerQR.jsx: lo comparten EQUIPOS y PROYECTOS.
...
export default function VistaEquipos({
  ...
  return (
    <div className={`seccion-menu flex-1 flex flex-col overflow-hidden ${theme.bg} ${theme.text}`}>
      ...
      {scannerAbierto && <ScannerQR titulo="Escanear QR del equipo" ayuda="Apunta al QR que muestra el creador del equipo en su pantalla." onResult={onQREscaneado} onClose={() => setScannerAbierto(false)} />}
