...
// Ítem del catálogo de un usuario a partir de uno de la base. El cable de acero va en
// metros: se liquida por lo trazado en el mapa, no por poste.
export const itemDesdeBase = (b) => ({
  id: b.id, nombre: b.nombre, unidad: esCableAcero(b.id) ? 'mts' : 'und', visible: true,
